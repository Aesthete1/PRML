...
\makeatother
    ...
    \subsubsection{Derivation complement of formula D.6 -
D.7}\label{derivation-complement-of-formula-d.6---d.7}
...
\]
    ...
    Note: I am not sure whether the meaning of ``\(\eta(x)\) must vanish at
the boundary of the integral'' is
\(\frac{\partial G}{\partial y'}\eta(x) = 0\)
